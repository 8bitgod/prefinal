...
public class prefinal extends PApplet {
...
public void packageAndSend(String address, int parameter) 
{
  ...
  port = PApplet.parseInt(portNumber.getText());
...

{
  ...
  if(!speedLock){speed = 160 + PApplet.parseInt(sliderSpeed.getValue());}
...
public void lightSwitch(boolean theFlag) {if(theFlag==true){addToConsole("Light activated"); packageAndSend("light", 1);}else{addToConsole("Light deactivated"); packageAndSend("light", 0);}}

public void LockingSwitch(boolean theFlag) {if(theFlag==true){keyLocked = true; addToConsole("Keys are locked");}else{keyLocked = false; addToConsole("Keys enabled");}}

public void ACT() {if(!speedLock){ addToConsole("Sensing.."); packageAndSend("Senso", 1);}}


public void addToConsole(String stringToAdd)
{
...
public void MySensor1(String stringToAdd)
...
{ 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "prefinal" };
    if (passedArgs != null) {
